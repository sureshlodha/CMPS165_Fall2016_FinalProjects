'use strict';
var toolyears = ['1990', '2000', '2011', '2012', '2013'];
...
function get_tool_text(country) {
    ...
    text += "</table>"
	text += "<p class=\"units\">Millions of US Dollars</p>";
    return text;
}

// calculates average annual change over 23-year period
function get_avg_pct_changes(country) {

    var yr_1990 = country["1990"], 
        yr_2013 = country ["2013"],
        chg_23, text_23;
   
    chg_23 = (yr_2013 - yr_1990) / yr_1990 * 100; // 50-year % change
    chg_23 = tool_format(chg_23) + "%"; // format % change
    chg_23.replace('-', '&minus;'); // replace dash with n-dash

    if (yr_1990 == -1) {
        chg_23 = "N/A"; // if no data exists from 1962, print "N/A" for 50 year
    }

    text_23 = "<tr><td>23-year change:</td><td>" + chg_23 + "</td></tr>";
...
var colorbrewer = {
    ...
    9: ["#becada", "#98abc5", "#8a89a6", "#7b6888", "#6b486b", "#c1908b", "#a05d56", "#d0743c", "#ff8c00"],
