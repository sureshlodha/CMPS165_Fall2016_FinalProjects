...
//Given to us by Professor Lodha; it is Mike Bostock's work 
//that we just had to modify to get it to work with the 
//programs specifications
//site: http://bl.ocks.org/mbostock/3884955
...
var margin = {top: 20, right: 110, bottom: 30, left: 80}, //margins to make sure everything is on screen
    width = 960 - margin.left - margin.right + 20, //another margin inside the margin
...
path = country.select("path");
  ...
  path
      .attr("stroke-dasharray", (totalLength*.9999+15) + " " + totalLength) //for creating the line
